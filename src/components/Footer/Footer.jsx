      ...
      <footer className={styles.footerWrapper}>
        <div className="container">
          ...
          <div className={`${styles.copyrightWrapper} row`}>
            ...
            <div
              className={`${styles.footerLinksTerms} col-sm-12 order-3 col-lg-6 order-lg-2"`}
            >
              <ul>
                <li>
            ...
            <div
              className={`${styles.footerCountry} col-sm-12 order-1 col-md-4 order-md-2 text-md-right col-lg-2 order-lg-3`}
            >
